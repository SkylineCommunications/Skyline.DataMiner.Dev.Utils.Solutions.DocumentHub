namespace Skyline.DataMiner.Solutions.DocumentHub.SDM.Maps
{
    ...
    internal class DocumentCategoryDomMapper
    {
        ...
        internal static class DocumentCategoryProperties
        {
            ...
            { ModuleId = ModuleId };
            internal static readonly FieldDescriptorID Name = new FieldDescriptorID(new Guid("d86b22d3-b231-4bc0-8c70-d38c50fd10d8"));
            internal static readonly FieldDescriptorID UploadPath = new FieldDescriptorID(new Guid("a45f2ac8-a6e4-4650-afe2-a6ea7f4262b8"));
            internal static readonly FieldDescriptorID Description = new FieldDescriptorID(new Guid("dc4c9953-9bdf-421f-9a0f-384ca4eace07"));
            internal static readonly FieldDescriptorID StorageType = new FieldDescriptorID(new Guid("36c92e1d-0108-4e6d-a411-189ecd9869ea"));
            internal static readonly FieldDescriptorID Extensions = new FieldDescriptorID(new Guid("9a62750a-de42-4241-b937-54ea4b79ca90"));
